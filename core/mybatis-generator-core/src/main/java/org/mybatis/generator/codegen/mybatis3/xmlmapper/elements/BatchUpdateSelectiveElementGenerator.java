...
public class BatchUpdateSelectiveElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getBatchUpdateSelectiveStatementId()));
        ...
        IntrospectedColumn defaultKeyColumn = new IntrospectedColumn();
        defaultKeyColumn.setActualColumnName("id");
        defaultKeyColumn.setJavaProperty("id");
        defaultKeyColumn.setJdbcTypeName("bigint");
        defaultKeyColumn.setTypeHandler("long");
        IntrospectedColumn primaryKeyColumn = introspectedTable.getPrimaryKeyColumns().stream().findFirst().orElse(
                defaultKeyColumn);

        for (IntrospectedColumn introspectedColumn : ListUtilities.removeGeneratedAlwaysColumns(
