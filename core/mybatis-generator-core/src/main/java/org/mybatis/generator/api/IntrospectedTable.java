...
public abstract class IntrospectedTable {
    ...
    public Optional<IntrospectedColumn> getColumn(String columnName) {
        return Stream.of(primaryKeyColumns.stream(), baseColumns.stream(), blobColumns.stream()).flatMap(
                Function.identity()).filter(ic -> columnMatches(ic, columnName)).findFirst();
    }
    ...
    public boolean hasJDBCDateColumns() {
        return Stream.of(primaryKeyColumns.stream(), baseColumns.stream()).flatMap(Function.identity()).anyMatch(
    ...
    public List<IntrospectedColumn> getNonBLOBColumns() {
        return Stream.of(primaryKeyColumns.stream(), baseColumns.stream()).flatMap(Function.identity()).collect(
                Collectors.toList());
    }
    ...
    public List<IntrospectedColumn> getNonPrimaryKeyColumns() {
        return Stream.of(baseColumns.stream(), blobColumns.stream()).flatMap(Function.identity()).collect(
                Collectors.toList());
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByPrimaryKeyStatementId("queryByPrimaryKey"); //$NON-NLS-1$
    ...
    public void setBatchUpdateSelectiveStatementId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_BATCH_UPDATE_SELECTIVE_STATEMENT_ID, s);
    }
    ...
    public String getBatchUpdateSelectiveStatementId() {
        return internalAttributes.get(InternalAttribute.ATTR_BATCH_UPDATE_SELECTIVE_STATEMENT_ID);
    }
    ...
    protected String calculateJavaClientInterfacePackage() {
        ...
        return config.getTargetPackage() + fullyQualifiedTable.getSubPackageForClientOrSqlMap(
    ...
    /**
     * This method should return a list of generated Kotlin files related to this table. This list could include a data
     * classes, a mapper interface, extension methods, etc.
     *
